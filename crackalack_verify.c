...
static int raw_table = 0, sorted_table = 0, truncate = VERIFY_DONT_TRUNCATE;
...
int main(int ac, char **av) {
  ...
  /* If nether --raw nor --sorted were specified, or if both were specified, this is an error. */
  if ((raw_table ^ sorted_table) == 0) {
